...
public:
	...
	float getRotation(float distanceToCentre, sf::RectangleShape paddleBounds); // used to determine how the balll should bounce of the paddle
	...
	float getSpeed();
	void setSpeed(float newSpeedValue);
