...
public:
	...
	sf::Color getColour();
	void resetPos(float fNewX,float fNewY); // used for resetting the balls speed, velocity, and postion each time it goes off screen
...
private:
	...
	float m_speedIncreaseMultiplier; // used to control at what rate the ball will increase in speed  
	float m_velocityIncrease;
